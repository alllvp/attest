...
class Participant(models.Model):
    ...
    contact = models.ForeignKey(Contact, verbose_name='Контактная информация', on_delete=models.DO_NOTHING, null=True, blank=True)
    created = models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')
...
class Supplier(models.Model):
    ...
    seller = models.ForeignKey(Participant, verbose_name='Продавец', related_name='seller', on_delete=models.CASCADE, unique=False)
    buyer = models.OneToOneField('Participant', verbose_name='Покупатель', related_name='buyer', on_delete=models.CASCADE)
    debt = models.PositiveIntegerField(verbose_name="Задолженность (в копейках)", default=0)
